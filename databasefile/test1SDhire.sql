...
CREATE TABLE IF NOT EXISTS `general_orders` (
  ...
  `orderType` enum('รับจ้างทั่วไป','เขียนโปรแกรม','กราฟิกดีไซน์','ตัดต่อวิดีโอ','แปลภาษา','การศึกษา','ถ่ายภาพ','ดนตรีและเสียง','เอกสาร','ซ่อมแซม','อื่นๆ') DEFAULT NULL,
...
REPLACE INTO `general_orders` (`order_ID`, `orderType`, `budjet`, `post_date`, `deadline`, `title`, `general_id`, `des_cript`) VALUES
...
REPLACE INTO `post_comments` (`comment_id`, `order_id`, `user_id`, `comment_text`, `created_at`) VALUES
...
-- Dumping data for table sdhire.service_reviews: ~2 rows (approximately)
REPLACE INTO `service_reviews` (`review_id`, `rating`, `comment`, `review_date`, `reviewer_id`, `student_id`, `review_image`) VALUES
...
REPLACE INTO `studentdata` (`studentID`, `facebook`, `firstname`, `lastname`, `instagram`, `line`, `URL`, `des_cription`, `Sgroup`, `email`) VALUES
...
-- Dumping data for table sdhire.user_job: ~1 rows (approximately)
REPLACE INTO `user_job` (`job_id`, `ID`, `job`, `user_number`, `job_type`, `title`, `budjet`, `des_Cription`, `job_create`, `created_at`, `service_image`) VALUES
	(17, 48, '', NULL, 'กราฟิกดีไซน์', 'dasdasd', 12231231.00, 'sadasdasdassada', 1, '2026-02-08 14:43:44', '1770561824823-0+logo-removebg-preview.png');
...
REPLACE INTO `userdata` (`ID`, `username`, `email`, `userPhoneNumber`, `pass_word`, `profile_image`, `roles`, `register_date`, `line`, `instagram`, `facebook`, `url`) VALUES
	...
	(48, 'pawatza', '67022063@up.ac.th', '2131231223sada', '$2b$10$CRLaM..D7HyzfPXGrh/c0umcLQX/qEPKeDSgtmHyyZ19NXl4H1/dG', '1770108530457-0+fba6e0db-67a1-4d6c-87f7-622c7f46f023.jpg', 'student', '2026-02-02', 'sadsadasdas', 'asdasda', NULL, NULL),
